...
<div class="wrapper">
  ...
  <table id="example1" class="table table-bordered table-striped">
    ...
    <tbody>
      ...
      if ($sql->num_rows > 0) { // Verificar si hay resultados
        ...
        echo '<td><div>Total: $<?= $sumaTotal ?></div></td>';
        echo '</tr>';
  ...
  <button onclick="eliminarTodosLosProductos()" class="btn btn-danger mb-3"><i class="fas fa-trash"></i> Eliminar Todos los Productos</button>
  </div>
</div>
