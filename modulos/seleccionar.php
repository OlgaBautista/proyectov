          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box" id="r-color">
                ...
                <a href="registro_usuario.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
               <?php } ?>
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box" id="v-color">
                ...
                <a href="formulario.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
               <?php } ?>
